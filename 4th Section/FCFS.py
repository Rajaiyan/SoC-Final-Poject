...
def main():
    ...
    for i in range(n):
        ...
        process_queue[i].append(int(input('Enter p_burst: ')))  # taking burst time of the process from user
    ...
    sys.stdout.write("Average Turn Around Time is: " + str((total_wtime + total_btime) / n))
